...
function enviar_email($arr) {
    ...
    switch ($arr['type']) {
        case 'alta':
            ...
            $ruta = "<a href='http://".$_SERVER['HTTP_HOST']."/proj_final_AngularJS/JoinElderly/#/user/activar/" . $arr['token'] . "'>aqu&iacute;</a>";
        ...
        case 'modificacion':
            ...
            $ruta = "<a href='http://".$_SERVER['HTTP_HOST']."/proj_final_AngularJS/JoinElderly/#/user/cambiarpass/" . $arr['token'] . "'>aqu&iacute;</a>";
            $body = 'Para recordar tu password pulsa ' . $ruta;
            break;

        case 'contact':
            $subject = 'Tu Petici&oacute;n a JoinElderly ha sido enviada<br>';
            $ruta = '<a href="http://'.$_SERVER['HTTP_HOST'].'/proj_final_AngularJS/JoinElderly/#/"' . '>aqu&iacute;</a>';
